...
export default function Home() {
  ...
  // const birthdayDate = new Date("October 01, 2025") // Change this date accordingly
  const birthdayDate = new Date("October 03, 2025") // Change this date accordingly - Live date
